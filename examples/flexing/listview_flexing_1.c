...
int main(){
    ...
    nocterm_widget_t* my_widget = nocterm_widget_new(0,0, NOCTERM_WIDGET_FOCUSABLE_NO, NOCTERM_WIDGET_TYPE_VIRTUAL);
    ...
    nocterm_widget_set_position(NOCTERM_WIDGET(buttons[0]), 8, 40);
    nocterm_widget_set_position(NOCTERM_WIDGET(buttons[1]), 9, 40);
    nocterm_widget_set_position(NOCTERM_WIDGET(buttons[2]), 10,40);
    nocterm_widget_set_position(NOCTERM_WIDGET(buttons[3]), 11, 40);
    nocterm_widget_set_position(NOCTERM_WIDGET(buttons[4]), 12, 40);
    nocterm_widget_set_position(NOCTERM_WIDGET(buttons[5]), 13, 40);

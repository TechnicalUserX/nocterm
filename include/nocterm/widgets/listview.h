...
#ifndef CONFIG_NOCTERM_LISTVIEW_ITEM_CONTENT_MAX_SIZE
    #define NOCTERM_LISTVIEW_ITEM_CONTENT_MAX_SIZE 1024
#else
    #define NOCTERM_LISTVIEW_ITEM_CONTENT_MAX_SIZE CONFIG_NOCTERM_LISTVIEW_ITEM_CONTENT_MAX_SIZE
#endif
